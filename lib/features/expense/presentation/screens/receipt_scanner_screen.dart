...
/// A QR / barcode scanner specialised for receipt and bill scanning.
///
/// Detects any barcode or QR code on a receipt, extracts amount / merchant
/// information from the raw value, and opens [AddExpenseScreen] with those
/// fields pre-filled.
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: const Text(
                        'Point camera at barcode or QR on the receipt',
                        style: TextStyle(
                          color: Colors.white,
